...
class TestDiff(unittest.TestCase):
    def setUp(self):
        ...
        max_12 = np.max(
            s1 * s2
        )  # largest of the samples in the element-wise product of `s1` and `s2`
        mean_abs_1 = np.mean(
            np.abs(s1)
        )  # average of the absolute value of the samples in `s1`
    ...
    def test_signals(self):
        ...
        self.assertAlmostEqual(
            ...
            self.expected[k],
            4,
            msg=f"tt: expected {self.expected[k]}, got {self.rec[k]}",
        )
        k = "Length"
        self.assertEqual(
            self.rec[k], self.expected[k], msg="Length of vectors is not right"
        )
        k = "Mean squares 1"
        self.assertAlmostEqual(
            self.rec[k],
            self.expected[k],
            4,
            msg=f"s1: expected {self.expected[k]}, got {self.rec[k]}",
        )
        k = "Sum 2"
        self.assertAlmostEqual(
            self.rec[k],
            self.expected[k],
            4,
            msg=f"s2: xpected {self.expected[k]}, got {self.rec[k]}",
        )
    ...
    def test_min(self):
        ...
        self.assertAlmostEqual(
            ...
            self.expected[k],
            4,
            msg=f"sum of squares: expected {self.expected[k]}, got {self.rec[k]}",
        )
    ...
    def test_sum(self):
        ...
        self.assertAlmostEqual(
            ...
            self.expected[k],
            3,
            msg=f"sum of s2: expected {self.expected[k]}, got {self.rec[k]}",
        )
    ...
    def test_lop(self):
        ...
        self.assertAlmostEqual(
            ...
            self.expected[k],
            4,
            msg=f"largest of product: expected {self.expected[k]}, got {self.rec[k]}",
        )
    ...
    def test_mabs(self):
        ...
        self.assertAlmostEqual(
            ...
            self.expected[k],
            3,
            msg=f"mean of absolute values: expected {self.expected[k]}, got {self.rec[k]}",
        )
    ...
    def test_mlog(self):
        ...
        self.assertAlmostEqual(
            ...
            self.expected[k],
            4,
            msg=f"Mean of log of positive: expected {self.expected[k]}, got {self.rec[k]}",
        )
